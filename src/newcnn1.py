...
def read_dataset(path):
    ...
    label_list = []
    i=-1
    my_list = os.listdir(r'C:\Users\User\Desktop\Setup\archive (1)\Original')
    for pa in my_list:
        i=i+1
        print(pa,"==================")
        for root, dirs, files in os.walk(r'C:\Users\User\Desktop\Setup\archive (1)\Original\\' + pa):

         for f in files:
            file_path = os.path.join(r'C:\Users\User\Desktop\Setup\archive (1)\Original\\'+pa, f)
...
def predict(fn):
    ...
    mo = load_model(r"C:\Users\User\Desktop\Main Project\leukemia\src\model1.h5")
